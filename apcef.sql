...
--
-- Host: 127.0.0.1
-- Generation Time: 07-Nov-2016 às 11:32
...
CREATE TABLE `planos` (
  ...
  `cpfdep1` varchar(20) NOT NULL,
  `ndep2` varchar(200) NOT NULL,
  `cpfdep2` varchar(20) NOT NULL,
  `ndep3` varchar(200) NOT NULL,
  `cpfdep3` varchar(20) NOT NULL,
  `ndep4` varchar(200) NOT NULL,
  `cpfdep4` varchar(20) NOT NULL,
  `ndep5` varchar(200) NOT NULL,
  `cpfdep5` varchar(20) NOT NULL,
  `ndep6` varchar(200) NOT NULL,
  `cpfdep6` varchar(20) NOT NULL,
  `ndep7` varchar(200) NOT NULL,
  `cpfdep7` varchar(20) NOT NULL,
  `ndep8` varchar(200) NOT NULL,
  `cpfdep8` int(20) NOT NULL,
  `ndep9` varchar(200) NOT NULL,
  `cpfdep9` int(11) NOT NULL,
  `ndep10` varchar(200) NOT NULL,
  `cpfdep10` varchar(20) NOT NULL,
