        ...
        <div id="top">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top " style="padding-top: 10px;">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <div>
                        <p style="position: absolute; left: 1170px; top: 15px;">Bem vindo Usuário</p>
                    </div>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li class="divider"></li>
                            <li><a href="login.html"><i class="icon-signout"></i> Sair </a>
                            </li>
                        </ul>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          ...
                          <button class="btn btn-success" style="position: relative; left: 950px; top: -20px;"><i class="icon-pencil icon-white"></i>Add Plano</button>
                        </div>
